...
#define GET_JSON_SETTING_DBL(SERVICE, FILENAMESPACE, SETTINGNAMESPACE) \
	(SERVICE).getSettingDouble(FILENAMESPACE::FILENAME, FILENAMESPACE::SETTINGNAMESPACE::PATH)
...
#define SET_JSON_SETTING_DBL(SERVICE, FILENAMESPACE, SETTINGNAMESPACE, SETTING_VALUE) \
	(SERVICE).setSettingDouble(FILENAMESPACE::FILENAME, FILENAMESPACE::SETTINGNAMESPACE::PATH, SETTING_VALUE)
