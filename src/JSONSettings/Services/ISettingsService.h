...
namespace systelab { namespace setting {
	...
	public:
		...
		virtual double getSettingDouble(const std::string& filepath, const std::string& settingPath) const = 0;
		...
		virtual void setSettingDouble(const std::string& filepath, const std::string& settingPath, double value) = 0;
