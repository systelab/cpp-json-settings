...
namespace systelab { namespace setting { namespace unit_test {
	...
	public:
		...
		void writeSectionSettingsIntoFile(int intValue, const std::string& strValue, bool boolValue)
		{
			std::stringstream ss;
			ss << "{" << std::endl;
			ss << "    \"Section\": " << std::endl;
	...
	{
		writeSectionSettingsIntoFile(123456, "file", false);
	...
	TEST_F(SettingsServiceSectionTest, testGetSettingsReturnsValuesFromCacheWhenAlreadyRead)
	{
		...
		writeSectionSettingsIntoFile(1111, "AAAA", false);
